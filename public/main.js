define("parameter", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("compressor", ["require", "exports", "parameter"], function (require, exports, parameter_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Compressor {
        constructor(opts) {
...
define("eq", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class EQ {
        constructor(opts) {
...
define("graphiceq", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class GraphicEQ {
        constructor(opts) {
...
define("track", ["require", "exports", "parameter", "eq", "compressor", "graphiceq"], function (require, exports, parameter_2, eq_1, compressor_1, graphiceq_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Track {
        constructor(mixer, opts) {
            ...
            this.opts = opts;
            this._soloMute = new parameter_2.Parameter(false, this.applySoloMute.bind(this));
            this._mute = new parameter_2.Parameter(opts.mute || false, this.applyMute.bind(this));
            this._solo = new parameter_2.Parameter(opts.solo || false, this.applySolo.bind(this));
            this._in_gain = new parameter_2.Parameter(opts.in_gain || 0, this.applyInGain.bind(this));
            ...
            this._pan = new parameter_2.Parameter(opts.pan || 0, this.applyPan.bind(this));
            this._level = new parameter_2.Parameter(opts.level || 0, this.applyLevel.bind(this));
        }
        applyOpts(opts) {
            this.opts = Object.assign(this.opts, opts);
...
define("mixer", ["require", "exports", "track"], function (require, exports, track_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Mixer {
        constructor() {
...
define("mixer-ui", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("main", ["require", "exports", "mixer", "mixer-ui"], function (require, exports, mixer_1, mixer_ui_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
